...
for synth in synths:
    for imp in imps:
        ...
        sub = dict(synth=synth, imp=imp, utilization_path=os.path.abspath(sub_folder + "utilization_report.txt"), timing_path=os.path.abspath(sub_folder + "timing_report.txt"), xpr_path=xpr_path)
